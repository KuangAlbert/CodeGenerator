...
_osEIINTVectorTable_c0:
 <xsl:for-each select="IRQ_Set/FUN[@Register = 'TAU']">
   ...
   .word _osUnhandledEIINTException//51 #define INTRLIN21 51
    ...
    <xsl:otherwise>
    .word _osUnhandledEIINTException//62
    </xsl:otherwise>
    </xsl:choose>
	</xsl:for-each>
	 <xsl:for-each select="IRQ_Set/FUN[@Register = 'DMA']">
   ...
   <xsl:for-each select="IRQ_Set/FUN[@Register = 'SPI']">
	...
	.word _osUnhandledEIINTException//128
	.word _osUnhandledEIINTException//129
	.word _osUnhandledEIINTException//130
	.word _osUnhandledEIINTException//131
	.word _osUnhandledEIINTException//132
	.word _osUnhandledEIINTException//133
	 <xsl:for-each select="IRQ_Set/FUN[@Register = 'TAU']">
	<xsl:choose>
