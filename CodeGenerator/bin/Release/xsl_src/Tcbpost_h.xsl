...
/* ISR function prototypes */ 
   ...
   <xsl:for-each select="IRQ_Set/FUN[@Register = 'TAU']">
	...
	void ISR_TAUD0I11_CAT2(void);//44
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUD0I13_CAT2(void);//45
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUD0I15_CAT2(void);//46
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
   ...
   <xsl:for-each select="IRQ_Set/FUN[@Register = 'SPI']">
	...
	void ISR_TAUB0I0_CAT2(void);//134
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
   ...
   <xsl:for-each select="IRQ_Set/FUN[@Register = 'TAU']">
	...
	void ISR_TAUB0I1_CAT2(void);//135
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUB0I2_CAT2(void);//136
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUB0I3_CAT2(void);//137
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUB0I4_CAT2(void);//138
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUB0I5_CAT2(void);//139
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUB0I6_CAT2(void);//140
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUB0I7_CAT2(void);//141
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUB0I8_CAT2(void);//142
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUB0I9_CAT2(void);//143
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUB0I10_CAT2(void);//144
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUB0I11_CAT2(void);//145
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUB0I12_CAT2(void);//146
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUB0I13_CAT2(void);//147
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUB0I14_CAT2(void);//148
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUB0I15_CAT2(void);//149
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUJ1I0_CAT2(void);//160
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUJ1I1_CAT2(void);//161
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUJ1I2_CAT2(void);//162
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
	...
	void ISR_TAUJ1I3_CAT2(void);//175
	</xsl:when>
    <xsl:otherwise>
    </xsl:otherwise>
    </xsl:choose>
