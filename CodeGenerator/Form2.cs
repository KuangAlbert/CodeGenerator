...
namespace CodeGenerator
{
    public partial class Form2 : Form
    {
        ...
        public void Current_Path(ref string value)
        {
            ...
            pin_path = textBox11.Text + "\\Pin64.xml";
            irq_path = textBox11.Text + "\\IRQ64.xml";
        ...
        public int ARS = 0;//选择了哪种模式，active、reset、standby
        ...
        //******************************************************************************************************************************************************
        public int count_number = 0, Alt_PM_value = 0, Alt_PFC_value = 0, Alt_PFCE_value = 0, Alt_PFCAE_value = 0, Alt_PMC_value = 0, Alt_PIBC_value = 0, Alt_PU_value = 0, Alt_PD_value = 0, Alt_PBDC_value = 0, Alt_PDSC_value = 0, Alt_PODC_value = 0, Alt_PIPC_value = 0, Alt_Port_value = 0;//中介初值
        public int[] Alt_PM_value_Act = { 65535, 65535, 65535, 65535, 65535, 65535, 65535, 65535 }, Alt_PFC_value_Act = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PFCE_value_Act = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PFCAE_value_Act = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PMC_value_Act = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PIBC_value_Act = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PU_value_Act = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PD_value_Act = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PBDC_value_Act = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PDSC_value_Act = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PODC_value_Act = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PIPC_value_Act = { 0, 0, 0, 0, 0, 0, 0 }, Alt_Port_value_Act = { 0, 0, 0, 0, 0, 0, 0 };
        public int[] Alt_PM_value_Res = { 65535, 65535, 65535, 65535, 65535, 65535, 65535, 65535 }, Alt_PFC_value_Res = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PFCE_value_Res = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PFCAE_value_Res = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PMC_value_Res = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PIBC_value_Res = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PU_value_Res = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PD_value_Res = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PBDC_value_Res = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PDSC_value_Res = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PODC_value_Res = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PIPC_value_Res = { 0, 0, 0, 0, 0, 0, 0 }, Alt_Port_value_Res = { 0, 0, 0, 0, 0, 0, 0 };
        public int[] Alt_PM_value_Sta = { 65535, 65535, 65535, 65535, 65535, 65535, 65535, 65535 }, Alt_PFC_value_Sta = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PFCE_value_Sta = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PFCAE_value_Sta = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PMC_value_Sta = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PIBC_value_Sta = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PU_value_Sta = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PD_value_Sta = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PBDC_value_Sta = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PDSC_value_Sta = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PODC_value_Sta = { 0, 0, 0, 0, 0, 0, 0 }, Alt_PIPC_value_Sta = { 0, 0, 0, 0, 0, 0, 0 }, Alt_Port_value_Sta = { 0, 0, 0, 0, 0, 0, 0 };//三种模式下各寄存器初值
                ...
                if (ctrl is RadioButton)
                {
                    ...
                    if (rck.Checked == true)
                    {
                        switch (num)
                        {
                            ...
                            case 1: alt_switch("s", "r", "r", "r", "s", pibc_flag, pu_flag, pd_flag, pbdc_flag, pdsc_flag, podc_flag, pipc_flag, pv_flag, group_flag);//PM  PFC  PFCE  PFCAE  PMC  PIBC  PU  PD  PBDC  PDSC PODC PIPC PV
                                break;
        ...
        public void irq_return_list(string[,] list_array, int k)
        {
            ...
            for (int i = 0; i < k; i++)
            {
                ...
                for (int j = 0; j < 12; j++)
                {
                    ...
                    {
                        lvi.SubItems.Add(list_array[i, j]); //模式
                    }
                }
        ...
        private void button1_Click_1(object sender, EventArgs e)//XML文件写入
        {
            ...
            else
            {
                ...
                addInterrupt(lvi.SubItems[3].Text, interrupt_flag);//直接在Pin界面配置中断
        ...
        private void linkLabel29_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)//传入端口名称、端口组号、端口号、模式
        {
        ...
        //                                                                  Pin中断初始化对应值                                                      
        //******************************************************************************************************************************************************  
        public string[] interruptFlag = new string[] { "OS", "INTP", "TAU", "ADC", "CAN", "RLIN", "IIC", "CSIH0", "PWGA", "WD", "DMA" };
        ...
        private void toolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            switch (ars)
            {
                ...
                case 3: Alt_PM_value_Sta[por] = Alt_PM_value_Sta[por] | (1 << gro);
                    ...
                    Alt_Port_value_Sta[por] = Alt_Port_value_Act[por] & ((1 << gro) ^ 65535);
                    break;
            }
            switch (ars)
            {
        ...
        public void addInterrupt(String fun, Boolean flag) //判断是否增加中断设置
        {
            if (!fun.Equals("NONE") && flag)//选择Alt模式
            {
                ...
                if (fun.IndexOf(interruptFlag[7]) >= 0) i = 7;//CSIH0
